...
![macOS Screenshot](https://rawcdn.githack.com/mikaelbr/node-notifier/master/example/mac.png)
![Native Windows Screenshot](https://rawcdn.githack.com/mikaelbr/node-notifier/master/example/windows.png)

## Input Example macOS Notification Center

![Input Example](https://rawcdn.githack.com/mikaelbr/node-notifier/master/example/input-example.gif)
